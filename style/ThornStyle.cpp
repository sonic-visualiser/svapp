...
/*
    ...
    This file is based on Rosegarden, a MIDI and audio sequencer and
...
ThornStyle::ThornStyle()
    ...
    : m_horizontalToolbarSeparatorPixmap(loadPix(":/icons/style/htoolbar-separator.png")),
      m_verticalToolbarSeparatorPixmap(loadPix(":/icons/style/vtoolbar-separator.png")),
      m_checkboxUncheckedPixmap(loadPix(":/icons/style/checkbox_unchecked.png")),
      m_checkboxUncheckedHoverPixmap(loadPix(":/icons/style/checkbox_unchecked_hover.png")),
      m_checkboxUncheckedDisabledPixmap(loadPix(":/icons/style/checkbox_disabled.png")),
      m_checkboxUncheckedPressedPixmap(loadPix(":/icons/style/checkbox_unchecked_pressed.png")),
      m_checkboxCheckedPixmap(loadPix(":/icons/style/checkbox_checked.png")),
      m_checkboxCheckedHoverPixmap(loadPix(":/icons/style/checkbox_checked_hover.png")),
      m_checkboxCheckedDisabledPixmap(loadPix(":/icons/style/checkbox_checked_disabled.png")),
      m_checkboxCheckedPressedPixmap(loadPix(":/icons/style/checkbox_checked_pressed.png")),
      m_checkboxIndeterminatePixmap(loadPix(":/icons/style/checkbox_indeterminate.png")),
      m_checkboxIndeterminateHoverPixmap(loadPix(":/icons/style/checkbox_indeterminate_hover.png")),
      //m_checkboxIndeterminateDisabledPixmap(loadPix(":/icons/style/checkbox_indeterminate_disabled.png")),
      m_checkboxIndeterminatePressedPixmap(loadPix(":/icons/style/checkbox_indeterminate_pressed.png")),
      m_radiobuttonUncheckedPixmap(loadPix(":/icons/style/radiobutton_unchecked.png")),
      m_radiobuttonUncheckedHoverPixmap(loadPix(":/icons/style/radiobutton_unchecked_hover.png")),
      m_radiobuttonUncheckedDisabledPixmap(loadPix(":/icons/style/radiobutton_unchecked_disabled.png")),
      m_radiobuttonUncheckedPressedPixmap(loadPix(":/icons/style/radiobutton_unchecked_pressed.png")),
      m_radiobuttonCheckedPixmap(loadPix(":/icons/style/radiobutton_checked.png")),
      m_radiobuttonCheckedHoverPixmap(loadPix(":/icons/style/radiobutton_checked_hover.png")),
      m_radiobuttonCheckedDisabledPixmap(loadPix(":/icons/style/radiobutton_checked_disabled.png")),
      m_radiobuttonCheckedPressedPixmap(loadPix(":/icons/style/radiobutton_checked_pressed.png")),
      m_arrowDownSmallPixmap(loadPix(":/icons/style/arrow-down-small.png")),
      m_arrowDownSmallInvertedPixmap(loadPix(":/icons/style/arrow-down-small-inverted.png")),
      m_arrowUpSmallPixmap(loadPix(":/icons/style/arrow-up-small.png")),
      m_arrowUpSmallInvertedPixmap(loadPix(":/icons/style/arrow-up-small-inverted.png")),
      m_arrowLeftPixmap(":/icons/style/arrow-left.png"),
      m_arrowRightPixmap(":/icons/style/arrow-right.png"),
      m_arrowUpPixmap(":/icons/style/arrow-up.png"),
      m_arrowDownPixmap(":/icons/style/arrow-down.png"),
      m_spinupPixmap(":/icons/style/spinup.png"),
      m_spinupHoverPixmap(":/icons/style/spinup_hover.png"),
      m_spinupOffPixmap(":/icons/style/spinup_off.png"),
      m_spinupPressedPixmap(":/icons/style/spinup_pressed.png"),
      m_spindownPixmap(":/icons/style/spindown.png"),
      m_spindownHoverPixmap(":/icons/style/spindown_hover.png"),
      m_spindownOffPixmap(":/icons/style/spindown_off.png"),
      m_spindownPressedPixmap(":/icons/style/spindown_pressed.png"),
      m_titleClosePixmap(":/icons/style/title-close.png"),
      m_titleUndockPixmap(":/icons/style/title-undock.png")
{
    ...
    m_standardPalette.setColor(QPalette::Window, QColor(0x30, 0x30, 0x30));
...
QIcon ThornStyle::standardIcon(QStyle::StandardPixmap standardIcon, const QStyleOption *option, const QWidget *parent) const
{
    ...
    case SP_MessageBoxInformation:
        return loader.load("style/messagebox-information");

    case SP_MessageBoxWarning:
        return loader.load("style/warning");

    case SP_MessageBoxCritical:
        return loader.load("style/messagebox-critical");

    case SP_MessageBoxQuestion:
        return loader.load("style/messagebox-question");
...
QSize ThornStyle::pixmapSize(const QPixmap &pixmap) const
{
    ...
    return QSize(int(round(pixmap.width() / pixmap.devicePixelRatio())),
                 int(round(pixmap.height() / pixmap.devicePixelRatio())));
#else
    return pixmap.size();
#endif
}
...
void ThornStyle::drawPrimitive(QStyle::PrimitiveElement element, const QStyleOption *option, QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_IndicatorToolBarHandle: {
        // top or bottom: image: url(:/icons/style/htoolbar-separator.png);
        // left or right: image: url(:icons/style/vtoolbar-separator.png);
